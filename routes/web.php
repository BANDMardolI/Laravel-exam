...
Route::get('users', [NewController::class, 'users']);
Route::get('deleteuser/{id}', [NewController::class, 'deleteuser']);
Route::get('ban/{id}', [NewController::class, 'ban']);
Route::get('unban/{id}', [NewController::class, 'unban']);
